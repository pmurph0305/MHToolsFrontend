...
describe('PHQ9 tests', () => {
    ...
    it('gets footers correctly', () => {
        ...
        const wrapFooters2 = shallow(<PHQ9 submissionResult='PHQ-9 submission successful.'/>);
        ...
        const wrapFooters3 = shallow(<PHQ9 submissionResult='PHQ-9 submission test fail'/>);
    ...
    it('selects and updates answers correctly', () => {
        ...
        wrapper2.find('select').first().simulate('change', mockEvent);
