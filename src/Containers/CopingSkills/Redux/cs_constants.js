...
// for displaying exmaple coping skills for a user.
export const DISPLAY_EXAMPLE_COPING_SKILLS = "DISPLAY_EXAMPLE_COPING_SKILLS";
...
export const UPDATE_CS_FAILED = "UPDATE_CS_FAILED";
